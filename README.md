...
- le cache de navigation utilise le `defaultCache` de Serwist (sans `navigationPreload`, sans cache custom) pour éviter les conflits entre caches et les erreurs `ERR_FAILED` sur les premières navigations ;
